...
File main = target.toPath().parent.resolve("src/main/java").toFile()
File mainParser = main.toPath().resolve("name/valery1707/kaitai/it/Ico.java").toFile()
...
assert !generatedParser.exists()
assert main.exists() && main.isDirectory()
assert mainParser.exists() && mainParser.isFile()
